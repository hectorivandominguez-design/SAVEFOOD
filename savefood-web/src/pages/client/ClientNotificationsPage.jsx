  ...
  return (
    <div style={styles.wrapper}>
      <div>
        ...
        <p style={styles.subtitle}>Consulta las novedades de tus pedidos.</p>
      </div>

      {loading ? (
        <div style={styles.loadingCard}>Cargando novedades de tu cuenta...</div>
      ) : error ? (
        ...
        <div style={styles.empty}>Todavía no tienes notificaciones registradas.</div>
      ) : (
